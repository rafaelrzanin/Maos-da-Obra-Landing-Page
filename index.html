...
<head>
    ...
    <meta name="description" content="Controle de obra para quem não entende de obra. Simples, passo a passo e com ajuda 24h.">
...
<body class="antialiased selection:bg-brand-gold selection:text-white">
    ...
    <section class="relative pt-24 pb-12 md:pt-32 md:pb-16 overflow-hidden flex items-center">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
                ...
                <div class="text-center md:text-left z-20">
                    ...
                    <div class="mb-8 h-16 flex items-center justify-center md:justify-start">
                    ...
                    <h1 class="font-display font-bold text-5xl md:text-6xl lg:text-7xl leading-[1.0] mb-6 tracking-tight animate-fade-in-up text-white" style="animation-delay: 0.1s">
                        Calma. <br>
                    ...
                    <p class="text-lg md:text-xl text-gray-400 mb-6 font-light leading-relaxed animate-fade-in-up" style="animation-delay: 0.2s">
                        Tem solução pros problemas da sua obra. <br>
                        <span class="text-white font-medium">Simples. Sem termo difícil. Sem enrolação.</span>
                    </p>

                    <!-- Micro-benefícios -->
                    <div class="flex flex-wrap justify-center md:justify-start gap-4 mb-8 animate-fade-in-up" style="animation-delay: 0.25s">
    ...
    <section id="como-funciona" class="py-20 md:py-24 bg-brand-dark">
    ...
    <section class="py-20 bg-gray-900 border-y border-white/5 overflow-hidden">
        <div class="container mx-auto px-4 text-center">
            <span class="text-brand-gold font-bold text-sm tracking-widest uppercase mb-2 block">Por dentro do app</span>
            <h2 class="text-3xl font-bold text-white mb-2">Veja como é simples</h2>
            <p class="text-sm text-gray-500 mb-12">Essas telas existem de verdade no app.</p>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center gap-12 max-w-5xl mx-auto">
                ...
                <div class="flex-1 text-center md:text-left">
                    <h2 class="text-3xl md:text-5xl font-display font-bold mb-6 text-white">Bateu dúvida? <br><span class="text-brand-gold">Pergunta pro Zé.</span></h2>
                    <p class="text-gray-400 text-lg mb-8">
                        É como ter alguém experiente do seu lado na obra. 
                        <br><strong>Fala simples. Responde na hora.</strong>
                        <br>Te ajuda a evitar erro bobo e gasto desnecessário.
                    </p>
                    ...
                    <a href="#precos" class="text-brand-gold font-bold hover:underline flex items-center justify-center md:justify-start gap-2">
                        Ver planos com o Zé incluído <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </a>
                </div>
            </div>
        </div>
    ...
    <!-- 6) RESULTADOS LÓGICOS -->
    <section class="py-20 bg-brand-dark">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-2xl font-bold text-white mb-12">O que muda quando você controla a obra</h2>
            
            <div class="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div class="p-6">
                    <h3 class="text-4xl font-bold text-white mb-2">Menos</h3>
                    <p class="text-xl text-brand-error font-medium">Atraso e Dor de Cabeça</p>
                </div>
                <div class="p-6 border-y md:border-y-0 md:border-x border-white/10">
                    <h3 class="text-4xl font-bold text-white mb-2">Menos</h3>
                    <p class="text-xl text-brand-error font-medium">Desperdício de Material</p>
                </div>
                <div class="p-6">
                    <h3 class="text-4xl font-bold text-white mb-2">Mais</h3>
                    <p class="text-xl text-green-400 font-medium">Dinheiro no seu Bolso</p>
                </div>
            </div>

            <div class="mt-12">
                <p class="text-gray-500 font-display font-bold text-lg uppercase tracking-widest">ERRAR NA OBRA CUSTA CARO.</p>
                <p class="text-gray-400 text-sm mt-1">E normalmente quem paga é você.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-brand-gold text-brand-dark overflow-hidden relative">
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
            <h2 class="text-xl font-bold uppercase tracking-widest mb-4 opacity-80">E o custo?</h2>
            ...
            <p class="mt-6 text-lg font-medium opacity-80">Um erro na obra custa muito mais do que isso.</p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto items-start">
                ...
                <div class="bg-white/5 rounded-3xl p-8 border border-white/10 backdrop-blur-sm hover:border-white/20 transition-all flex flex-col h-full">
                    ...
                    <a href="https://maos-da-obra-2-0.vercel.app/login?plan=mensal" class="block w-full text-center py-3 rounded-xl border border-white/20 text-white hover:bg-white/5 transition-colors font-semibold mt-auto">
                        Começar Agora
                    </a>
                </div>
                ...
                <div class="bg-white/5 rounded-3xl p-8 border border-white/10 backdrop-blur-sm hover:border-white/20 transition-all flex flex-col h-full">
                    ...
                    <div class="my-4">
                        <span class="text-3xl font-bold text-white">R$ 97,00</span><span class="text-gray-500">/total</span>
                    </div>
                    <!-- Justificativa -->
                    <div class="mb-6 text-sm font-medium text-green-400">
                    ...
                    <a href="https://maos-da-obra-2-0.vercel.app/login?plan=semestral" class="block w-full text-center py-3 rounded-xl border border-white/20 text-white hover:bg-white/5 transition-colors font-semibold mt-auto">
                        Começar Agora
                    </a>
                </div>
                ...
                <div class="bg-gradient-to-b from-gray-900 to-black rounded-[2rem] p-8 border-2 border-brand-gold shadow-[0_0_50px_rgba(217,119,6,0.3)] relative transform md:scale-110 z-20 flex flex-col h-full">
                    ...
                    <a href="https://maos-da-obra-2-0.vercel.app/login?plan=vitalicio" class="btn-primary w-full py-4 rounded-xl text-lg shadow-xl flex items-center justify-center gap-2 animate-pulse-slow mt-auto">
